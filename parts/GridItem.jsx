...
var GridItem = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			{ className: '_intui_grid_item_outer ' + this.props.outerClassName, onMouseEnter: this.props.onMouseEnter, onMouseLeave: this.props.onMouseLeave, ref: 'item', style: style },
			this.props.children
		);
	}
});
